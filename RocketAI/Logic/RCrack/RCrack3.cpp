...
bool CRCrack3::TranslatePut(byte &byChair, byte &byChair1, byte &byType, byte &byRspType, byte &byGrade, byte &byCount)
{
...
bool CRCrack3::TranslateGvp(byte &byChair, byte &byChair1, byte &byType, byte &byRspType, byte &byGrade, byte &byCount)
{
	if (byType == TYPE_CHA)
	{
...
void CRCrack3::Think(byte byChair1, byte byType, byte byRspType, byte byGrade, byte byCount)
{
